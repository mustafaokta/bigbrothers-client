...
import { listRegion, addRegion, updateRegion, deleteRegion } from '../../helpers/connections/admin';
...
setUpcomingEventsEditOffcanvas(!upcomingEventsEditOffcanvas);
	...
	addRegion ({ data: postData }, user.token!)
			.then((res) => {
	...
	const handleEditAction = (post_data: any) => {
		...
		updateRegion({ data: postData }, user.token!)
			.then((res) => {
	...
	const handleDeleteAction = (postData: any) => {
		deleteRegion({ data: postData}, user.token!)
			.then((res) => {
				setListData(res);
		})
		.catch((err:any) => {
				...
				<form onSubmit={handleSubmit((data) => handleEditAction(data))}>
					...
					<div className='row g-4'>
						    ...
						    <div className='col-12'>
								<FormGroup id='name' label='Adı' isFloating>
