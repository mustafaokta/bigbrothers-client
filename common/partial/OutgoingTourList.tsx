                ...
                <tr key={item.id}>
                  ...
                  <td>
                    <div>
                      <div>
                        {
                          tourData.content.filter(
                            (el: any) => el.id == item.tourId
                          )[0].name
                        }
                      </div>
                      <div className="small text-muted">
                        {
                          agencyData.content.filter(
                            (el: any) => el.id == item.tour.agencyId
                          )[0].name
                        }
                      </div>
                    </div>
                  ...
                  <td>
                    {
                      hotelData.content.filter(
                        (el: any) => el.id == item.hotelId
                      )[0].name
                    }
                  </td>
