...
const TourList: FC<ICommonUpcomingEventsProps> = ({ isFluid }) => {
	...
	const { register, handleSubmit, reset, formState: { errors }, getValues, control, watch, setValue } = useForm();
		...
		<>
			...
			<Modal
					...
					<ModalHeader setIsOpen={setNewItemOffcanvas}>
						<OffCanvasTitle id='newRecordIncomingTitle'>Giden Yeni Kayıt</OffCanvasTitle>
					</ModalHeader>
