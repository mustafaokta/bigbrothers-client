...
import { listTourTypes, addTourTypes, updateTourTypes, deleteTourTypes } from '../../helpers/connections/admin';
...
setUpcomingEventsEditOffcanvas(!upcomingEventsEditOffcanvas);
	...
	updateTourTypes({ data: postData }, user.token!)
			.then((res) => {
	...
	const handleDeleteAction = (postData: any) => {
	 		deleteTourTypes({ data: postData}, user.token!)
			.then((res) => {
				setListData(res);
		})
		.catch((err:any) => {
			...
			<Card stretch={isFluid}>
				<CardHeader borderSize={1}>
					<CardLabel icon='Alarm' iconColor='info'>
						<CardTitle>Tur Tipleri</CardTitle>
					</CardLabel>
