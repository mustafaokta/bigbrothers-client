...
export const postAddMediaPayment = (
  postData: { mediaPayment: any },
  token: string
) => {
  return new Promise((resolve, reject) => {
    axios
      .post(MEDIA_PAYMENT_ADD, postData, {
...
export const updateMediaPayment = (
  postData: { mediaPayment: any },
  token: string
) => {
  return new Promise((resolve, reject) => {
    axios
      .post(UPDATE_MEDİA_PAYMENT, postData, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => resolve(res.data))
      .catch((err) => reject(err));
...
export const postAddParachuteEntry = (
  postData: { data: any },
  token: string
) => {
  return new Promise((resolve, reject) => {
    axios
      .post(PARACHUTE_ENTRY, postData, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => resolve(res.data))
      .catch((err) => reject(err));
...
export const parachuteEntryUpdate = (
  postData: { data: any },
  token: string
) => {
  return new Promise((resolve, reject) => {
    axios
      .post(PARACHUTE_LIST_UPDATE, postData, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => resolve(res.data))
      .catch((err) => reject(err));
...
export const parachuteEntryDelete = (
  postData: { data: any },
  token: string
) => {
  return new Promise((resolve, reject) => {
    axios
      .post(PARACHUTE_LIST_DELETE, postData, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((res) => resolve(res.data))
      .catch((err) => reject(err));
